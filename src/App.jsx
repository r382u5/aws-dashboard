...
const FLASHCARDS = [
    ...
    { term: "AWS Pricing Calculator", domain: "第4分野: 請求、料金、サポート", beginnerDesc: "「AWSを使うといくらかかるか」を事前に計算・見積もりするためのツール。（Cost Explorerは過去の分析用）", intermediateDesc: "AWSサービスの利用料金を見積もるためのツール。オンプレミスからの移行によるコスト削減評価や、将来のアーキテクチャコストの予測に使用します。", examTip: "「AWSサービスの将来のコストを見積もる」ツールとして正解になります。Cost Explorer(過去の分析)と区別しましょう。" }
];
